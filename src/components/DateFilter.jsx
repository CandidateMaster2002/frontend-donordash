...
const DateFilter = ({ filter, onFilterChange, loading }) => {
  ...
  return (
    <div className="py-4 max-w-lg mx-auto text-gray-800 dark:text-gray-800">
      {/* Filter Type Buttons */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-around gap-3 w-full text-lg">
        <div className="font-semibold text-lg whitespace-nowrap text-center sm:text-left text-gray-800 dark:text-gray-800">
          Filter By Date
        </div>
      ...
      {draft.type === 'month' && (
        <div className="mt-6 space-y-3">
          ...
          <input
            ...
            className="w-full p-2 border border-gray-300 dark:border-gray-300 bg-white dark:bg-white text-gray-800 dark:text-gray-800 rounded-md
        ...
        <div className="mt-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-300 dark:border-gray-300 bg-white dark:bg-white text-gray-800 dark:text-gray-800 px-3 py-2
                       focus:ring-2 focus:ring-purple-500 focus:outline-none"
            />
          </div>
