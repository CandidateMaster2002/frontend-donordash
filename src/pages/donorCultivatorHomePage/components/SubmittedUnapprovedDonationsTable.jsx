...
const SubmittedUnapprovedDonationsTable = ({ donations, loading }) => {
  return (
    <section>
      ...
      {loading ? (
        <p className="rounded-md bg-blue-50 px-4 py-3 text-blue-800">
          Loading submitted unapproved donations...
        </p>
      ) : donations.length === 0 ? (
            ...
            <table className="min-w-full text-center">
              ...
              <tbody className="divide-y divide-gray-100 text-gray-800">
                {donations.map((donation, index) => (
                  <tr key={donation.id} className="hover:bg-red-50/40">
...
export default SubmittedUnapprovedDonationsTable;
