                  ...
                  {showOptions && (
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        const selected = shownDonors.find(
                          (d) => String(d.donorId) === donorId
                        );

                        if (selected) {
                          setValue('donorId', selected.donorId);
                          setSearchTerm(
                            selected.username || selected.donorName || ''
                          );
                          setShowOptions(false);
                          handleDonorChange({
                            target: { value: selected.donorId },
                          });
                        }
                      }}
                    >
